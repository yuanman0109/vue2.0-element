<template>
  <el-table :data="tableData" border style="width: 100%">
    <el-table-column type="index" label="编号" sortable width="180"></el-table-column>
    ...
    <el-table-column
      ...
      <span>
        ...
        <el-button  type="danger" size="small" @click.native.prevent="deleteRow($index, tableData)">删除</el-button>
      </span>
    </el-table-column>
  </el-table>
</template>
